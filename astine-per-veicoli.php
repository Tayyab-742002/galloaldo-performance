...
<!-- Event snippet for Richiesta Catalogo Generale conversion page
...
function gtag_report_conversion(url) {
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-859280756/dt27CN7407ABEPSq3pkD',
...
<script>
  gtag('event', 'conversion', {'send_to': 'AW-859280756/DKaECLXfqogYEPSq3pkD'});
</script>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
...
<title>astine per bandiera per veicoli, supporti bandiere per auto.</title>
  <meta name="description" content="Ampia scelta di aste per bandiere per automobili e motociclette, con attacco a magnete o da finestrino auto, aste in fibra per bandiere da bicicletta.">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/flagpoles/vehicle-flagpoles.php"><img src="../../img/uk-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
              ...
              <div class="masonry__sizer"></div>
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/astine-per-bandiere-per-veicoli/cod288AST-astina-bandiera-per-veicoli.jpg" alt="Astina per bandiera per veicoli"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Astina ottone cromato per auto e moto</h6>
               ...
               <div class="masonry__item  alluminio">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/astine-per-bandiere-per-veicoli/cod288-astina-bandiera-per-veicoli.jpg" alt="Astina per bandiera per veicoli con base magnetica"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Astina con base magnetica (resistenza fino a 30Km/h)</h6>
               ...
               <div class="masonry__item  alluminio">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/astine-per-bandiere-per-veicoli/cod305-astina-bandiera-per-veicoli.jpg" alt="Astina per bandiera in plastica per autovetture"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Astina in plastica da finestrino</h6>
