...
<!-- Favicon -->
  ...
  <title>Cookie Policy della Azienda Gallo Aldo.</title>
  <meta name="description" content="Gallo Aldo garantisce la privacy dei propri utenti, adottando tutte le norme e precauzioni previste dalla legge italiana in materia di privacy. ">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="./en-EN/cookie-policy.php"><img src="https://www.galloaldo.com/flag/uk-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
            ...
            <div class="col-xl-9 offset-xl-1 col-lg-11">
              <div data-anim-child="slide-up delay-1" class="sectionHeading -lg">
                ...
                <h1 class="sectionHeading__title leading-sm">
				  ...
				  <p style="text-align: left" class="mt-16">
GALLO ALDO S.R.L. <br>
Via della Stella 54 – 25062 CONCESIO (BS) <br>
Partita IVA e Codice Fiscale: 04658180981 <br>
Numero REA: BS - 631213 <br>
Capitale sociale: 15.000,00 I.V.<br><br>
					  Indirizzo email del Titolare: <a href="mailto:info@galloaldo.com">info@galloaldo.com</a><br>
				  </p>
				   <p>
<a href="https://www.iubenda.com/privacy-policy/60230473/cookie-policy" class="iubenda-black no-brand iubenda-noiframe iubenda-embed iubenda-noiframe iub-body-embed" title="Cookie Policy">Cookie Policy</a><script type="text/javascript">(function (w,d) {var loader = function () {var s = d.createElement("script"), tag = d.getElementsByTagName("script")[0]; s.src="https://cdn.iubenda.com/iubenda.js"; tag.parentNode.insertBefore(s,tag);}; if(w.addEventListener){w.addEventListener("load", loader, false);}else if(w.attachEvent){w.attachEvent("onload", loader);}else{w.onload = loader;}})(window, document);</script></p> 
              </div>
            </div>
          </div>
          <!-- row end -->
