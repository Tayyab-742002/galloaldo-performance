...
input.error {
  ...
  <title>Italian flagspoles production Gallo Aldo, contacts.</title>
  <meta name="description" content="Get the best accessories in the world of Flags. Get in contact with Gallo Aldo, an Italian company leader in flagspoles and accessories flags production.">	
            ...
            <div class="col-xl-9 offset-xl-1 col-lg-11">
              <div data-anim-child="slide-up delay-1" class="sectionHeading -lg">
                ...
                <h1 class="sectionHeading__title leading-sm">
                  Looking for a manufacturer of flagpoles and accessories?
                </h1>
				   <h4 class=" leading-sm">
                  Gallo Aldo company leader in its sector
                </h4>
              </div>
            </div>
          </div>
                ...
                <form class="row x-gap-40 y-gap-32" method="POST" action="sendmailag.php" id="formcontatto" name="formcontatto">
                  <div class="col-lg-6">
                    <label class="js-input-group">
                      Company Name *
                      <input type="text" name="ragionesociale" required placeholder="Company Name">
                  ...
                  <div class="col-lg-6">
                    ...
                    <label class="js-input-group">
                      Address *
                      <input type="text" name="indirizzo" required placeholder="Address">
                      <span class="form__error"></span>
                    </label>
                  </div>
                    ...
                    <label class="js-input-group">
                      City *
                      <input type="text" name="localita" required placeholder="City">
                      <span class="form__error"></span>
                    </label>
                  </div>
                    ...
                    <label class="js-input-group">
                      Country *
                      <input type="text" name="provincia" required placeholder="Country">
                      <span class="form__error"></span>
                    </label>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <label class="js-input-group">
                      ZIP Code *
                      <input type="text" name="cap" placeholder="ZIP Code" required>
                      <span class="form__error"></span>
                    </label>
                  </div>
                  ...
                  <div class="col-12">
                    <label class="js-input-group">
                      Note/request
                      <textarea name="message" rows="2" placeholder="Insert your notes"></textarea>
                      <span class="form__error"></span>
                    </label>
                  </div>
