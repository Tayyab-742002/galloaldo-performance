...
<!-- Favicon -->
  ...
  <title>Flag pole Installation Made in Italy - Gallo Aldo.</title>
  <meta name="description" content="Gallo Aldo is ad Italian leader company in Flag pole Installations. Contact us now to get your flags installed. We travel the whole Italy for our customers">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../installazioni.php"><img src="../img/it-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
