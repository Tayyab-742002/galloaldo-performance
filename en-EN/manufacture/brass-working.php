...
<script>
  ...
  <title>Brass Working, Brass Flags accessories.</title>
  <meta name="description" content="Gallo Aldo adopt the best machines to work brass and copper plate and it provides brass plates for flags strictly made in italy.">	
    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../produzione/lavorazioni-articoli-in-lastra-di-ottone.php"><img src="../../img/it-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="../../produzione/img/lastra-ottone-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    The best machines for working brass plate
                  </h1>
                </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              ...
              <p class="text-lg text-white mt-24 sm:mt-16">
               We create some of our articles with the best machines to work brass and copper plate. Brass plates strictly made in italy.
              </p>
            </div>
          </div>
          <!-- row end -->
