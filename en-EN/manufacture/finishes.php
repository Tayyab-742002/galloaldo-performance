...
<script>
  ...
  <title>Finishes for flags by Gallo Aldo</title>
  <meta name="description" content="Finishes for flags by Gallo Aldo. We cut our tubes with the best cutting machines to guarantee our customers precision and perfection">	
    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../produzione/finiture.php"><img src="../../img/it-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="../../produzione/img/finiture2-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    Guaranteeing customers precision and perfection
                  </h1>
                </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              <div class="d-flex text-xs tracking-md pt-4">
                ...
                <p class="uppercase fw-500 text-light">Processing</p>
              </div>

              <p class="text-lg text-white mt-24 sm:mt-16">
               We cut our tubes with the best cutting machines to guarantee our customers precision and perfection. Our products leave the warehouse being processed and are taken to our best partners for brass polishing, transparent or powder coating and electroplating chrome plating.
              </p>
            </div>
          </div>
          <!-- row end -->
