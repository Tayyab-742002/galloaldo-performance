...
<script>
  ...
  <title>Brass Working for Flags accessories.</title>
  <meta name="description" content="Brass Working for Flags accessories. We hot stamp some items  such as table bases, balls and terminals for flagpoles from brass bars. Request the catalogue">	
    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../produzione/stampaggio-a-caldo-e-tornitura.php"><img src="../../img/it-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="../../produzione/img/stampaggio-a-caldo-tornitura-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    From solid brass bar to finished product
                  </h1>
                </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              ...
              <p class="text-lg text-white mt-24 sm:mt-16">
               From the solid brass bar we hot stamp some items such as table bases, balls and terminals for flagpoles etc.. These items, once printed, are rectified by means of numerical control lathes.
              </p>
            </div>
          </div>
          <!-- row end -->
