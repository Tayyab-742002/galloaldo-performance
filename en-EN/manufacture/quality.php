...
<script>
  ...
  <title>Control quality process, Flags Accesories.</title>
  <meta name="description" content="We provide a deep attention to the control quality process in our Flagspoles production. We have more than 20 years of experience. Get the catalogue now.">	
    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../produzione/qualita.php"><img src="../../img/it-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="../../produzione/img/quality-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    Quality and Innovation always first.
                  </h1>
                </div>
          ...
          <div class="row justify-content-between">
            ...
            <div class="col-auto">
              <div class="d-flex text-xs tracking-md pt-4">
                ...
                <p class="text-light uppercase fw-500">Quality Control</p>
              </div>
            </div>
            ...
            <div class="col-xl-7 col-lg-8">
              <div class="md:mt-20">
                ...
                <p class="text-lg text-white mt-24 sm:mt-16">
                  The quality control is a careful and meticulous evaluation of the products manufactured: that is, it consists of a series of strict controls on the components, just out of the processing phases, performed both at dimensional and aesthetic level. All this is done by means of our experts, who verify conformity
                </p>
              </div>
            </div>
