...
<script>
  ...
  <title>Raw materials selection Flags Accessories.</title>
  <meta name="description" content="Raw materials selection Flags Accessories. We collaborate with the best Italian producers of raw materials to guarantee the customer a high quality product..">	
    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../produzione/materie-prime.php"><img src="../../img/it-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="../../produzione/img/materie-prime-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    We collaborate with the best Italian producers of raw materials
                  </h1>
                </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              <div class="d-flex text-xs tracking-md pt-4">
                ...
                <p class="uppercase fw-500 text-light">Material Selections</p>
              </div>

              <p class="text-lg text-white mt-24 sm:mt-16">
                We collaborate with the best Italian producers of raw materials to guarantee the customer a high quality product. We choose the best drawing shops to buy brass, aluminium, stainless steel and iron.
              </p>
            </div>
          </div>
          <!-- row end -->
