...
<script>
  ...
  <title>From mould to finished producto, Flags Accessories.</title>
  <meta name="description" content="From mould to finished producto, Flags Accessories. We collaborate with the best brass shell foundries. Request our Flags Accessories Catalogue right now.">	
    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../produzione/stampaggio-metalli-e-fusioni.php"><img src="../../img/it-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="../../produzione/img/stampo-bg.jpg"></div>
        </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              <div class="d-flex text-xs tracking-md pt-4">
                ...
                <p class="uppercase fw-500 text-light">Stamp and Casting</p>
              </div>

              <p class="text-lg text-white mt-24 sm:mt-16">
               We collaborate with the best brass shell foundries in order to obtain from our own moulds die-cast products of excellent and guaranteed quality.
              </p>
            </div>
          </div>
          <!-- row end -->
