          ...
          <div class="container layout-pt-sm">
			...
			<!--ITEM-->
               <div class="masonry__item goccia">
				  ...
				  <p class="fs12" style="background: #ABABAB;padding-top:8px;padding-bottom:8px"><strong style="padding-left:8px">Cod</strong> G1 95x200cm | G2 95x300cm | G3 95x400cm</p>	  
				   </div>
              </div>
				<!--ITEM-->
               <div class="masonry__item vela">
				  ...
				  <p class="fs12" style="background: #ABABAB;padding-top:8px;padding-bottom:8px"><strong style="padding-left:8px">Cod</strong> V1 75x200cm | V2 55x300cm | V3 75x400cm</p>	  
				   </div>
              </div>
