...
<script>
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <title>Produttore leader in italia di aste pennoni e accessori per bandiere :: Gallo Aldo aste per bandiere made in Italy Brescia</title>
            ...
            <div class="col-lg-4 col-sm-6">
              ...
              <div data-anim-child="slide-up delay-4" class="serviceCard -type-2">
                <div class="serviceCard__content">
                  ...
                  <div class="serviceCard__navButton navButton -md mt-24">
                    <a href="./accessori/index.php" title="Gallo Aldo Brescia Accessori per supporti portabandiera, sistemi di issaggio, e molto altro" class="navButton__item button -outline-white text-white">
                      <i data-feather="arrow-right" class="icon"></i>
                    </a>
                  </div>
                </div>
