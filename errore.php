            ...
            <div class="col-xl-9 offset-xl-1 col-lg-11">
              <div data-anim-child="slide-up delay-1" class="sectionHeading -lg">
                ...
                <h3 class="sectionHeading__title leading-sm">
				  ...
				  <p>Gentile cliente ti ringraziamo per aver contattato Gallo Aldo. Siamo spiacenti ma la tua richiesta NON è stata inviata correttamente, verifica di aver compilato il Form in tutte le sue parti o riprova più tardi.<br>Per qualsiasi altra info e richiesta, ti invitiamo a contattarci direttamente telefonicamente o via mail ai nostri riferimenti</p>
              </div>
            </div>
          </div>
          <!-- row end -->
