...
if(substr(basename($_SERVER['PHP_SELF']), 0, 11) == "imEmailForm") {
	...
	if(@$_POST['action'] != 'check_answer') {
		if(!isset($_POST['imJsCheck']) || $_POST['imJsCheck'] != 'FA76FA66303ADD4C83EAD73546C3DF6F' || (isset($_POST['imSpProt']) && $_POST['imSpProt'] != ""))
			die(imPrintJsError());
		$form->mailToOwner('info@galloaldo.com', 'info@galloaldo.com', 'Richiesta catalogo prodotti dal sito www.galloaldo.com', 'Con la presente richiediamo invio vs. catalogo prodotti.
