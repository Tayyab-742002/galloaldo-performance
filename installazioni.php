          ...
          <div class="row justify-content-center text-center">
            <div class="col-xl-7 col-lg-8">
              ...
              <div class="sectionHeading -lg">
                <h3 class="sectionHeading__title">
Le nostre installazioni                </h3>
				  <p class=" mt-56 lg:mt-40 md:mt-20">Diamo al cliente una scelta con il servizio "Chiavi in Mano" che comprende la vendita del prodotto
e la posa dello stesso, tramite una squadra di professionisti. In questa raccolta di immagini diamo esempio ad alcune installazioni fatte, mostrandovi l'impegno e la passione che ogni giorno ci mettiamo per soddisfare il cliente.
