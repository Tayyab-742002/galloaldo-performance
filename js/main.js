...
/*--------------------------------------------------
  02. Preloader — removed; no-op stubs keep PJAX from crashing
---------------------------------------------------*/

const Preloader = (function() {

  function init() {
    gsap.registerEffect({ name: 'preloaderInitial', effect: () => gsap.timeline(), extendTimeline: true });
    gsap.registerEffect({ name: 'preloaderShow',    effect: () => gsap.timeline(), extendTimeline: true });
    gsap.registerEffect({ name: 'preloaderHide',    effect: () => gsap.timeline(), extendTimeline: true });
  }
