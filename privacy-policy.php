...
<!-- Favicon -->
  ...
  <title>Privacy Policy by Gallo Aldo</title>
  <meta name="description" content="Gallo Aldo garantisce il trattamento dei dati personali secondo le leggi dello Stato Italiano, accedi a questa sessione per scoprire di più. Grazie. ">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="./en-EN/privacy-policy.php"><img src="https://www.galloaldo.com/flag/uk-flag.svg" class="mw36"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
...
Capitale sociale: 15.000,00 I.V.<br><br>
				   ...
				   <p>
<a href="https://www.iubenda.com/privacy-policy/60230473" class="iubenda-black no-brand iubenda-noiframe iubenda-embed iubenda-noiframe iub-body-embed" title="Privacy Policy">Privacy Policy</a><script type="text/javascript">(function (w,d) {var loader = function () {var s = d.createElement("script"), tag = d.getElementsByTagName("script")[0]; s.src="https://cdn.iubenda.com/iubenda.js"; tag.parentNode.insertBefore(s,tag);}; if(w.addEventListener){w.addEventListener("load", loader, false);}else if(w.attachEvent){w.attachEvent("onload", loader);}else{w.onload = loader;}})(window, document);</script></p>  
              </div>
            </div>
          </div>
          <!-- row end -->
