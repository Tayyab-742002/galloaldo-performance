...
<title>Accessori per gagliardetti, vasta gamma di traversine e borchie./title>
  <meta name="description" content="Gallo Aldo, di Concesio (BS) offre una vasta gamma di accessori per gagliardetti: traversine, borchie e terminali per gagliardetti. Accedi al nostro catalogo.">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/accessories/pennant-accessories.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
              ...
              <div class="masonry__sizer"></div>
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/accessori-per-gagliardetti/cod254.jpg" alt="accessori per gagliardetti"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Traversino in Acciaio</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/accessori-per-gagliardetti/cod252.jpg" alt="accessori per gagliardetti"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Borchia in Ottone</h6>
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/accessori-per-gagliardetti/cod252C.jpg" alt="accessori per gagliardetti"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Borchia in Ottone Nichelato</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/accessori-per-gagliardetti/cod252-7.jpg" alt="accessori per gagliardetti"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
