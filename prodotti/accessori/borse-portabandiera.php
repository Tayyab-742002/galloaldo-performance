...
<title>Borse Portabandiera, scegli il Made in Italy.</title>
  <meta name="description" content="Le nostre bors portabandiera sono studiate per il trasporto in sicurezza dei tuoi accessori per bandiere, richiedi il catalogo con le borse di diverse misure adesso.">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/accessories/flagpole-bags.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
              ...
              <div class="masonry__sizer"></div>
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/borse-portabandiera/cod179.jpg" alt="borse e cinture portabandiera"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Borsa 80x20</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/borse-portabandiera/cod178-15.jpg" alt="borse e cinture portabandiera"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Borsa 100x15</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/borse-portabandiera/cod178-25.jpg" alt="borse e cinture portabandiera"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Borsa 100x25</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/borse-portabandiera/cod178-120.jpg" alt="borse e cinture portabandiera"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Borsa 120x25</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/borse-portabandiera/cod178-130.jpg" alt="borse e cinture portabandiera"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Borsa 130x25</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/borse-portabandiera/cod180RIG.jpg" alt="borse e cinture portabandiera"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Borsa con interno rigido</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/borse-portabandiera/cod188B.jpg" alt="borse e cinture portabandiera"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/borse-portabandiera/cod180.jpg" alt="borse e cinture portabandiera"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Cintura per aste</h6>
