...
<title>Piantane con cordoni di delimitazione, acquista Made in Italy.</title>
  <meta name="description" content="Piantane, cordoni di delimitazione e accessori. Scopri le piantane con cartello personalizzabile e intercambiabile, ideali per sale e meeting rooms.">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/accessories/delimitation-column.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
          ...
          <div class="row">
            <div class="col-xl-7 col-lg-8">
              ...
              <div class="sectionHeading -lg">
				  ...
				  <p><img src="../../img/italy_flag.svg" style="width: 200px" alt="Piantane con cordoni di delimitazione"></p>
              ...
              <div class="masonry__sizer"></div>
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/piantane-delimitazione/cod140-CART.jpg" alt="piantane di delimitazione e cordoni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Cartello Direzionale</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/piantane-delimitazione/cod139.jpg" alt="piantane di delimitazione e cordoni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Piantana Cromata</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/piantane-delimitazione/cod139-ECO.jpg" alt="piantane di delimitazione e cordoni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Piantana Inox</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/piantane-delimitazione/cod138.jpg" alt="piantane di delimitazione e cordoni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Piantana Oro</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/piantane-delimitazione/cod162.jpg" alt="piantane di delimitazione e cordoni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Cordone</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/piantane-delimitazione/cod163.jpg" alt="piantane di delimitazione e cordoni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Capocorda Ottone Cromato</h6>
               ...
               <div class="masonry__item inox">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/piantane-delimitazione/cod163C.jpg" alt="piantane di delimitazione e cordoni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Capocorda Ottone Oro</h6>
