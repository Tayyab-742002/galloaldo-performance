...
<script>
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <title>aste militari, aste in velluto per corpi d'Armata.</title>
   <meta name="description" content="La Gallo Aldo da sempre fornisce aste militari, aste per bandiere per ogni corpo d'Armata: carabinieri, esercito, marina, aviazione, richiedi il catalogo adesso.">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/flagpoles/army-flagpoles.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
...
<!--ITEM-->
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/aste-per-bandiere-militari/cod299-asta-bandiera-da-guerra-esercito.jpg" alt="Asta bandiera da guerra esercito"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Asta per bandiera da guerra esercito</h6>
				  <p class="fs12 desccodice"><strong style="padding-left:8px">Cod</strong> 299</p>
				<p class="fs12 descprodotto"><strong>Specifiche</strong><br>
					  Misure e dettagli come da capitolato dell'esercito</p>
				   </div>
              </div>
               ...
               <div class="masonry__item  ferro">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/aste-per-bandiere-militari/cod300-asta-bandiera-stendardo-marina-militare.jpg" alt="Asta ibandiera stendardo marina militare"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Asta stendardo marina militare</h6>
