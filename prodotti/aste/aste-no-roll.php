...
<title>aste da esterno per bandiere sistema no roll</title>
  <meta name="description" content="Scopri le nostre mitiche aste per bandiere con sistema no roll, così le tue bandiere non si attorciglieranno mai più alle aste. Richiedi preventivo veloce.">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/flagpoles/no-roll-flagpoles.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
          ...
          <div class="row justify-content-between">
            <div class="col-lg-12">
              <div class="d-flex text-xs tracking-md pt-4">
                ...
                <h5 class=" fw-500">Mai più bandiere arrotolate col nostro <strong>SISTEMA BREVETTATO NO-ROLL</strong></h5>
              </div>

              <p class="text-lg mt-16 mb-16">
                Il sistema No-Roll è un prodotto anti arrotolamento <strong>esclusivo</strong> e <strong>brevettato</strong> dalla Gallo Aldo<br>
				  <strong>Cod. NO ROLL</strong> Sistema anti arrotolamento per aste ø 32 mm<br>
<strong>Cod. 141/G/NO ROLL</strong> Asta alluminio ø 32 cm 200 con sistema anti arrotolamento<br>
<strong>Cod. 142/G/NOROLL</strong> Asta alluminio ø 32 cm 250 con sistema anti arrotolamento<br>
<strong>Cod. 143/G/NOROLL</strong> Asta alluminio ø 32 cm 300 con sistema anti arrotolamento
              </p>
				
				<p class="mt-12"><img src="img/galloaldo-noroll-system-main.jpg" style="max-height: 750px"></p>
