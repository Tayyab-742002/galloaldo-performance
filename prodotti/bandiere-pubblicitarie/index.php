...
<script>
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <title>Bandiere pubblicitare, bandiere a vela e a goccia, scegli il made in Italy.</title>
   <meta name="description" content="La Gallo Aldo si è specializzata nella fornitura di strutture per bandiere pubblicitarie, bandiera a vela e a goccia, richiedi il catalogo gratuito.">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/flying-banners/index.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
          ...
          <div class="row justify-content-center text-center">
            <div class="col-12">
              ...
              <p class="text-5xl sm:text-5xl xs:text-4xl leading-sm fw-700 text-white">
                Eleva la tua pubblicità con le nostre aste per bandiere, strutture per bandiere a vela e bandiere a goccia
              </p>

              <p class="text-xl md:text-lg text-white mt-16">
                Alla Gallo Aldo non temiamo rivali nelle strutture per bandiere pubblicitarie
              </p>
          ...
          <div class="row">
            <div class="col-xl-7 col-lg-8">
              ...
              <div class="sectionHeading -lg">
                 ...
                 Strutture per Bandiere Pubblicitarie
                </h1>
				   <div class="spacer-small"></div>
			   <p>
               Oggi tutto passa attraverso la rete, ma volete mettere l'effetto visivo di una bandiera pubblicitaria esposta fuori dalla vostra attività? <br />

Alla Gallo Aldo vantiamo un'esperienza ventennale nella produzione produzione di <b>aste per bandiere pubblicitarie</b>, <b>bandiere a vela</b> e <b>bandiere a goccia</b>! Siamo orgogliosi di offrire soluzioni di alta qualità per le esigenze pubblicitarie dei nostri clienti. La nostra gamma di prodotti di alta qualità è progettata per soddisfare le vostre esigenze di marketing visivo, garantendo allo stesso tempo durata e resistenza. Senza snobbare il mercato cinese, ma il nostro prodotto è di un altro mondo.<br />

Le nostre bandiere a vela sono un'ottima scelta per la pubblicità all'aperto, grazie alla loro forma elegante e alla capacità di sopportare venti forti. Richiedi subito il nostro catalogo.<br />
               </p>
              ...
              <div class="col-auto">
                <div class="filter-button-group text-dark fw-500">
                  <button class="button mr-20 btn-active" data-filter="*">Show All</button>
					<button class="button mr-20" data-filter=".vela">Vela</button>
                  <button class="button mr-20" data-filter=".goccia">Goccia</button>
                </div>
              </div>
...
<!--ITEM-->
               <div class="masonry__item goccia">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/codG.jpg" alt="strutture per bandiere pubblicitarie a vela e a goccia"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Goccia</h6>
				  <p class="fs12 desccodice"><strong style="padding-left:8px">Cod</strong> G1 95x200cm | G2 95x300cm | G3 95x400cm</p>	  
				   </div>
              </div>
				<!--ITEM-->
               <div class="masonry__item vela">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/codV.jpg" alt="strutture per bandiere pubblicitarie a vela e a goccia"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Vela</h6>
				  <p class="fs12 desccodice"><strong style="padding-left:8px">Cod</strong> V1 75x200cm | V2 75x300cm | V3 75x400cm</p>	  
				   </div>
              </div>
