...
function gtag_report_conversion(url) {
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <title>pali per bandiere, in alluminio ferro e ottone, Gallo Aldo aste per bandiere,.</title>
   <meta name="description" content="Se cerchi pali per bandiere, la Gallo Aldo di Concesio in provincia di Brescia è in grado di fornirti dei prodotti professionali, artigianali e made in Italy.">	
              ...
              <div class="masthead__content">
                ...
                <div data-split="lines" data-split-page-reveal class="mr-minus-lg md:mr-0">
                  <h1 class="masthead__title fw-700 text-white js-title">
                    Una vasta gamma a catalogo di pali per bandiere
                  </h1>
                </div>

                <div data-split="lines" data-split-page-reveal>
                  <p class="masthead__text text-light mt-40 md:mt-20 js-text">
                    Ad ogni bandiera la sua asta. Forniamo pali e aste per bandiere da interno, da esterno, aste in velluto personalizzabili e disponibili in diverse misure.
                  </p>
                </div>
            ...
            <div class="col-xl-9 col-md-12">
              <div class="sectionHeading -sm">
                ...
                <h2 class="sectionHeading__title fw-600 text-white">
                  I nostri pali per bandiere sono in alluminio anodizzato argento oppure oro, ferro o ottone cromato o lucidato, personalizzabili con velluto da parata, e disponibili in diverse lunghezze e vari diametri.
                </h2>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-4 col-sm-6">
              ...
              <div data-anim-child="slide-up delay-4" class="serviceCard -type-2">
                <div class="serviceCard__content">
                  ...
                  <div class="serviceCard__navButton navButton -md mt-24">
                    <a href="../aste/aste-militari.php" title="Gallo Aldo Brescia aste per bandiere. Le nostre aste per bandiere specifiche per l'ambito militare sono realizzate e prodotte seguendo le specifiche del capitolato dell'esercito italiano." class="navButton__item button -outline-white text-white">
                      <i data-feather="arrow-right" class="icon"></i>
                    </a>
                  </div>
                </div>
