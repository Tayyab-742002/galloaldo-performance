...
<script>
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <title>Pomoli e terminali in rame x aste per bandiere.</title>
   <meta name="description" content="Ampia selezione di pomoli e terminali in rame da esterno, si tratta di articoli ideali per aste, pali e pennoni per bandiere. Richiedi il catalogo adesso..">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/flagpoles-balls-and-finials/outdoor-copper-balls.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="layout-pt-md layout-pb-md">
        <div class="section-filter">
          ...
          <div class="container layout-pt-sm">
			...
			<!--ITEM-->
               <div class="masonry__item rame">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/pomoli/cod400.jpg" alt="pomoli e terminali per bandiere"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Pomolo Conico</h6>
               ...
               <div class="masonry__item rame">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/pomoli/cod401.jpg" alt="pomoli e terminali per bandiere"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
               ...
               <div class="masonry__item rame">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/pomoli/cod402.jpg" alt="pomoli e terminali per bandiere"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Pomolo Sferico</h6>
