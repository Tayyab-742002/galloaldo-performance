...
<title>set da sala tricolore per bandiere da interno.</title>
  <meta name="description" content="Ecco il set da sala da interno per bandiere. Le aste sono colorate di verde, bianco e rosso, una soluzione moderna per esporre tre bandiere nel proprio ufficio.">	
	<?php include ("../../headscript.html")?>
  <!-- Preload LCP background image (banner-top-categoria-prodotti) -->
  <link rel="preload" as="image" fetchpriority="high" href="../../img/flag-bg.jpg">
</head>
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/set/set-italia.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
        ...
        <div class="section-filter">
          ...
          <div class="container">
            ...
            <div class="row y-gap-32 justify-content-between align-items-center">
              ...
              <div class="col-auto">
                 <a class="button -md -outline-black text-black" href="../../richiedi-catalogo.php" title="Le aste per bandiere da interno ed esterno prodotte da Gallo Aldo sono in alluminio anodizzato argento oppure oro, ferro e ottone cromato o lucidato oro, personalizzabili con velluto da parata, e disponibili in diverse lunghezze e vari diametri. " aria-label="Richiedi il Catalogo delle aste per bandiere da interno ed esterno prodotte da Gallo Aldo" data-barba>
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/set-italia/cod-set-italy.jpg" alt="set da sala per bandiere"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Base 3 sedi ø280mm</h6>
				  <p class="fs12 desccodice"><strong style="padding-left:8px">Cod</strong> SetItaly</p>	  
				  <p class="fs12 descprodotto"><strong>Dimensioni</strong><br>
					  H.2mt per aste ø22mm</p></div>
              </div>
