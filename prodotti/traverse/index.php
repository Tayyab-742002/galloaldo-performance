...
<title>traverse per aste per bandiere, traverse per labari e gonfaloni, made in Italy.</title>
  <meta name="description" content="Gallo Aldo propone una vasta gamma di accessori per bandiere. Traverse per labari, traverse per stendardi e affini.">	
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../../en-EN/products/stendards-cross-bars/index.php" aria-label="Switch to English version"><img src="../../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
              ...
              <div class="masonry__sizer"></div>
                  ...
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/cod-121C.jpg" alt="traverse per labari e gonfaloni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Traversa in Ottone Lucido</h6>
				  <p class="fs12 desccodice"><strong style="padding-left:8px">Cod</strong> da 121L a 129L</p>	  
				  <p class="fs12 descprodotto"><strong>Dimensioni</strong><br>
					  ø15mm Lunghezza: 60-65-70-75-80-85-90-95-100cm</p></div>
              </div>
				<!--ITEM-->
               <div class="masonry__item ottonecromato">
                  <div class="ratio">
				  ...
				  <p class="fs12 descprodotto"><strong>Dimensioni</strong><br>
					  ø22mm Lunghezza 95cm | 105cm</p></div>
              </div>
				<!--ITEM-->
               <div class="masonry__item ottonecromato">
                  <div class="ratio">
				  ...
				  <p class="fs12 descprodotto"><strong>Dimensioni</strong><br>
					  ø22mm Lunghezza da 105cm a 150cm</p></div>
              </div>
				<!--ITEM-->
               <div class="masonry__item ottonelucido">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/cod121L.jpg" alt="traverse per labari e gonfaloni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Traversa in Ottone Cromato</h6>
               ...
               <div class="masonry__item ottonelucido">
                  <div class="ratio">
				   ...
				   <div class="productdesc">
				  <h6 class="pb8">Traversa in Ottone Cromato</h6>
				  <p class="fs12 desccodice"><strong style="padding-left:8px">Cod</strong> 128C/22 | 129C/22</p>	  
				  <p class="fs12 descprodotto"><strong>Dimensioni</strong><br>
					  ø22mm Lunghezza: 95cm | 105cm</p></div>
              </div>
				<!--ITEM-->
               ...
               <div class="masonry__item ottonecromato">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/cod-121SB.jpg" alt="traverse per labari e gonfaloni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Traversa a Sbalzo Cromata</h6>
				  <p class="fs12 desccodice"><strong style="padding-left:8px">Cod</strong> 121SB</p>	  
				  <p class="fs12 descprodotto">Lunghezza massima 80cm <strong>pomolo escluso</strong><br>
					  </p></div>
              </div>
				<!--ITEM-->
               <div class="masonry__item ottonecromato">
                  <div class="ratio">
                    <div class="portfolioCard__img">
                      <div class="portfolioCard__img__inner">
                        <div class="bg-image js-lazy" data-bg="img/cod121.jpg" alt="traverse per labari e gonfaloni"></div>
                      </div>
                    </div>
                </div>
				   <div class="productdesc">
				  <h6 class="pb8">Traversa Semplice</h6>
