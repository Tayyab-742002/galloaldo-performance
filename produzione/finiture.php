    ...
    <main class="">
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="./img/finiture2-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    Garantire alla clientela precisione e perfezione
                  </h1>
                </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              ...
              <p class="text-lg text-white mt-24 sm:mt-16">
               Tagliamo i nostri tubi con le migliori macchine da taglio per garantire alla clientela precisione e perfezione. I nostri prodotti escono dal magazzino in fase di lavorazione e vengono portati dai nostri partner migliori per la la lucidatura dell’ottone, la verniciatura trasparente o a polvere e la cromatura galvanica.
              </p>
            </div>
          </div>
          <!-- row end -->
