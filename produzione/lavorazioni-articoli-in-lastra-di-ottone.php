    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../en-EN/manufacture/brass-working.php" aria-label="English"><img src="../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="./img/lastra-ottone-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    Le migliori macchine per lavorare la lastra d’ottone
                  </h1>
                </div>
            ...
            <div class="col-xl-7 col-lg-8">
              <ul class="breadcrumbs text-white mb-40">
                ...
                <li class="breadcrumbs-item active" aria-current="page">
                  Lavorazioni articoli in lastra di ottone
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              ...
              <p class="text-lg text-white mt-24 sm:mt-16">
               Creiamo alcuni nostri articoli con le migliori macchine per lavorare la lastra d’ottone e di rame. Lastre in ottone rigorosamente made in italy.
              </p>
            </div>
          </div>
          <!-- row end -->
