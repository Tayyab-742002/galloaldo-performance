    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../en-EN/manufacture/raw-materials.php" aria-label="English"><img src="../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="./img/materie-prime-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    Collaboriamo con i migliori produttori di materie prime italiani
                  </h1>
                </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              ...
              <p class="text-lg text-white mt-24 sm:mt-16">
                Collaboriamo con i i migliori produttori di materie prime italiani per garantire al cliente un prodotto di elevata qualità Scegliamo le migliori trafilerie per acquistare l’ottone, l’alluminio l’acciaio inox e il ferro.
              </p>
            </div>
          </div>
          <!-- row end -->
