    ...
    <main class="">
				...
				<!--SWITCH LANG-->
					<div class="nav__info__item js-navInfo-item" style="margin-top:0 !important;">
					   <div class="nav__info__content text-lg text-white mt-16">
                        <a href="../en-EN/manufacture/spedizioni.php" aria-label="English"><img src="../img/uk-flag.svg" class="mw36" alt="English"></a>    
                      </div>
					   </div>
				<!--END SWTICH LANG-->	
					</div>
      ...
      <section class="masthead -type-work-1 -full-screen bg-black sm:text-center js-masthead-type-work-1 js-bg">
        <div data-parallax="0.7" class="masthead__bg overlay-black-md js-image">
          <div data-parallax-target class="bg-image js-lazy js-bg-item" data-bg="./img/shipping-bg.jpg"></div>
        </div>
              ...
              <div class="col-xl-10 col-sm-10 z-3">
                ...
                <div data-split="lines">
                  <h1 class="masthead__title text-white fw-700 js-title">
                    Garanzia e sicurezza di consegna
                  </h1>
                </div>
          ...
          <div class="row justify-content-between">
            <div class="col-xl-7 col-lg-8">
              <div class="d-flex text-xs tracking-md pt-4">
                ...
                <p class="uppercase fw-500 text-light">Imballaggi</p>
              </div>

              <p class="text-lg text-white mt-24 sm:mt-16">
               Usiamo scatole rigide per export evitando gli urti che i corrieri provocano, i nostri articoli vengono inseriti in tubi di cartone di spessore 5 mm chiusi dagli appositi tappi sulle estremità.
              </p>
            </div>
          </div>
          <!-- row end -->
