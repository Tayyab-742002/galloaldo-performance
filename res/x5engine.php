...
class ImCart {
    ...
    {
        //TODO send mail only if not already sent (it's necessary to save the 'already sent data' somewhere)...
        global $imSettings;
    ...
    public function fromDbOrderToOrderData($order, $payment, $shipping)
    {
        $orderData = array(
            ...
            'payment' => array(
                ...
                'html' => $order['order']['payment_html'], // FIXME it's necessary to use DB for storing this data, for now is useless so no column will be created for this
                'htmlCheck' => '<a href="http://google.it">escapecheck</a>',
