...
<!-- Favicon -->
  ...
  <title>Richiesta Catalogo inviata.</title>
  <meta name="description" content="Gallo Aldo è produzione aste e pennoni per bandiere, accessori per esporre le bandiere in esterno o in interno. Accedi al Catalogo ora.">	
  <!-- Event snippet for Richiesta Catalogo Generale conversion page -->


<?php include ("./headscript.html")?>
<script>
  gtag('event', 'conversion', {'send_to': 'AW-859280756/dt27CN7407ABEPSq3pkD'});
</script>
</head>
          ...
          <div class="row">
            <div class="col-xl-9 offset-xl-1 col-lg-11">
              <div data-anim-child="slide-up delay-1" class="sectionHeading -lg">
                ...
                <h3 class="sectionHeading__title leading-sm">
                  Grazie per averci contattato
                </h3>
				  <p>Gentile cliente ti ringraziamo per aver contattato Gallo Aldo. La tua richiesta verrà presa in esame dal nostro staff e provvederemo a ricontattarti al più presto. <br>
<strong>Se non ricevi risposta alla tua prenotazione ti invitiamo a contattarci telefonicamente.</strong><br>Per qualsiasi altra info e richiesta, ti invitiamo a contattarci direttamente telefonicamente o via mail ai nostri riferimenti</p>
              </div>
            </div>
          </div>
          <!-- row end -->
              ...
              <div class="row x-gap-48 y-gap-48">
                ...
                <div class="col-lg-auto offset-lg-1 col-md-6">
                  ...
                  <div class="text-dark mt-12">
                    ...
                    <div class="mt-4">
                      <a class="button -underline" href="tel:+390308900679">+39-030.8900679</a>
                    </div>
					 <div class="mt-4">
                      <a class="button -underline" href="tel:+393312128211">+39-3312128211</a><br>(Simone Resp. Commerciale)
                    </div> 
                  </div>
                </div>
