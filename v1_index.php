...
<script>
 ...
 <link rel="stylesheet" href="css/sm.css">
  ...
  <title>aste, pennoni e accessori per bandiere :: Gallo Aldo</title>
            ...
            <div class="col-xl-4 col-lg-5 col-md-8">
              <div class="sectionHeading -sm">
                ...
                <h2 class="sectionHeading__title leading-sm text-white fw-600">
                  Un prodotto di altissima qualità, mantenendo, allo stesso tempo, un prezzo concorrenziale e molto competitivo
                </h2>
              </div>
            </div>
          ...
          <div class="row x-gap-60 y-gap-48 layout-pt-md">
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="">
                ...
                <p class="mt-16">
                  Capitanata dalla nostra <strong>Lara</strong> che gestisce tutto quello che riguarda la parte contabile e quella amministrativa.
                </p>
              </div>
            </div>
...
<!-- ========== START COPYING HERE ========== -->
		<div id="popup-1" class="slickModal">
			<div class="window">
				<!-- Your popup content -->
				<a href="https://www.paliperbandiere.com/" target="_blank" class="closeModal setCookie-1">
					<img src="./img/popup/sito_pali_post.jpg" />
				</a><!-- / Your popup content -->
			</div>
		</div>
<!-- ========== END COPYING HERE ========== -->
