            ...
            <div class="col-lg-4 col-md-6">
              <div data-anim-child="slide-up delay-2" class="serviceCard">
                <div class="serviceCard__content">
                  ...
                  <p class="serviceCard__text mt-16">
                  Tutta l'amministrazione della Gallo Aldo è capitanata dalla nostra <strong>Lara</strong> che gestisce tutti gli aspetti ed i dettagli che riguardano sia la parte di gestione contabile sia quella amministrativa.
                  </p>
